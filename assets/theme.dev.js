 ...
 */ (function (scrollLock, Flickity, themeCurrency, Ajaxinate) {
    ...
    showFiltersOnDesktop() {
      ...
      filterTriggers.forEach((element, index) => {
        const isCurrentFilterExpanded = element.classList.contains(
          ...
          shouldCloseExpandedOnes = closeAllFilters && isCurrentFilterExpanded;
  ...
  class Drawer {
    ...
    toggle(e) {
      ...
      if (!drawer2) return;
      drawer2.classList.contains(classes$L.open) ? this.close() : this.open(e);
    }
    open(e) {
...
//# sourceMappingURL=/s/files/1/0108/4293/1258/t/23/assets/theme.dev.js.map?v=1731756302
